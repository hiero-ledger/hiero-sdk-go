...
type CryptoUpdateTransactionBody struct {
	...
	HookIdsToDelete []int64 `protobuf:"varint,19,rep,packed,name=hook_ids_to_delete,json=hookIdsToDelete,proto3" json:"hook_ids_to_delete,omitempty"`
	// *
...
func (x *CryptoUpdateTransactionBody) GetHookIdsToDelete() []int64 {
	if x != nil {
...
func (x *CryptoUpdateTransactionBody) GetHookCreationDetails() []*HookCreationDetails {
	if x != nil {
...
var file_crypto_update_proto_goTypes = []any{
	...
	(*HookCreationDetails)(nil),         // 9: com.hedera.hapi.node.hooks.HookCreationDetails
}
var file_crypto_update_proto_depIdxs = []int32{
	...
	9,  // 12: proto.CryptoUpdateTransactionBody.hook_creation_details:type_name -> com.hedera.hapi.node.hooks.HookCreationDetails
