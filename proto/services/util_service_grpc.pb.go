...
func (UnimplementedUtilServiceServer) Prng(context.Context, *Transaction) (*TransactionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Prng not implemented")
}
func (UnimplementedUtilServiceServer) AtomicBatch(context.Context, *Transaction) (*TransactionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AtomicBatch not implemented")
}
...
func RegisterUtilServiceServer(s grpc.ServiceRegistrar, srv UtilServiceServer) {
	// If the following call panics, it indicates UnimplementedUtilServiceServer was
