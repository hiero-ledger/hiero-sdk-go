...
const file_account_pending_airdrop_proto_rawDesc = "" +
	"\n" +
	"\x1daccount_pending_airdrop.proto\x12\x05proto\x1a\x11basic_types.proto\"\xe7\x01\n" +
	...
	"\fnext_airdrop\x18\x03 \x01(\v2\x17.proto.PendingAirdropIdR\vnextAirdropB&\n" +
	"\"com.hederahashgraph.api.proto.javaP\x01b\x06proto3"

var (
	file_account_pending_airdrop_proto_rawDescOnce sync.Once
	file_account_pending_airdrop_proto_rawDescData []byte
)

func file_account_pending_airdrop_proto_rawDescGZIP() []byte {
	file_account_pending_airdrop_proto_rawDescOnce.Do(func() {
		file_account_pending_airdrop_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_account_pending_airdrop_proto_rawDesc), len(file_account_pending_airdrop_proto_rawDesc)))
	})
...
func file_account_pending_airdrop_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_account_pending_airdrop_proto_rawDesc), len(file_account_pending_airdrop_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
