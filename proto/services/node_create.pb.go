...
type NodeCreateTransactionBody struct {
	...
	AssociatedRegisteredNode []uint64 `protobuf:"varint,10,rep,packed,name=associated_registered_node,json=associatedRegisteredNode,proto3" json:"associated_registered_node,omitempty"`
...
func (x *NodeCreateTransactionBody) GetAssociatedRegisteredNode() []uint64 {
	if x != nil {
...
const file_node_create_proto_rawDesc = "" +
	"\n" +
	"\x11node_create.proto\x12 com.hedera.hapi.node.addressbook\x1a\x11basic_types.proto\"\xb0\x04\n" +
	...
	"\x13grpc_proxy_endpoint\x18\t \x01(\v2\x16.proto.ServiceEndpointR\x11grpcProxyEndpoint\x12<\n" +
	"\x1aassociated_registered_node\x18\n" +
	" \x03(\x04R\x18associatedRegisteredNodeB&\n" +
