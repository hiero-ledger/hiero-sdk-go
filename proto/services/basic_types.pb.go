...
func (x *HookCall) GetFullHookId() *HookId {
	if x != nil {
		if x, ok := x.Id.(*HookCall_FullHookId); ok {
			return x.FullHookId
		}
	}
	return nil
...
type HookCall_FullHookId struct {
	// *
	// The full id of the hook to call, when the owning entity is not forced by the call site.
	FullHookId *HookId `protobuf:"bytes,1,opt,name=full_hook_id,json=fullHookId,proto3,oneof"`
}

type HookCall_HookId struct {
	// *
	// The numeric id of the hook to call, when the owning entity is forced by the call site.
	HookId int64 `protobuf:"varint,2,opt,name=hook_id,json=hookId,proto3,oneof"`
}

func (*HookCall_FullHookId) isHookCall_Id() {}
...
const file_basic_types_proto_rawDesc = "" +
	...
	"\ahook_id\x18\x02 \x01(\x03R\x06hookId\"N\n" +
	"\fHookEntityId\x121\n" +
	"\n" +
	"account_id\x18\x01 \x01(\v2\x10.proto.AccountIDH\x00R\taccountIdB\v\n" +
	"\tentity_id\"\xa5\x01\n" +
	"\bHookCall\x121\n" +
	"\ffull_hook_id\x18\x01 \x01(\v2\r.proto.HookIdH\x00R\n" +
	"fullHookId\x12\x19\n" +
	"\ahook_id\x18\x02 \x01(\x03H\x00R\x06hookId\x128\n" +
...
var file_basic_types_proto_depIdxs = []int32{
	...
	19, // 5: proto.HookCall.full_hook_id:type_name -> proto.HookId
