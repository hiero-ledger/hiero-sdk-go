...
const (
	...
	SubType_CRYPTO_TRANSFER_WITH_HOOKS SubType = 8
)
...
const (
	...
	HederaFunctionality_RegisteredNodeCreate HederaFunctionality = 113
	// *
	// Update a registered node
	HederaFunctionality_RegisteredNodeUpdate HederaFunctionality = 114
	// *
...
func (*HookId) ProtoMessage() {}

func (x *HookId) ProtoReflect() protoreflect.Message {
	mi := &file_basic_types_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HookId.ProtoReflect.Descriptor instead.
func (*HookId) Descriptor() ([]byte, []int) {
	return file_basic_types_proto_rawDescGZIP(), []int{10}
}

func (x *HookId) GetEntityId() *HookEntityId {
	if x != nil {
		return x.EntityId
	}
	return nil
...
func (x *HookEntityId) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HookEntityId) ProtoMessage() {}

func (x *HookEntityId) ProtoReflect() protoreflect.Message {
	mi := &file_basic_types_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HookEntityId.ProtoReflect.Descriptor instead.
func (*HookEntityId) Descriptor() ([]byte, []int) {
	return file_basic_types_proto_rawDescGZIP(), []int{11}
}

func (x *HookEntityId) GetEntityId() isHookEntityId_EntityId {
	if x != nil {
		return x.EntityId
	}
	return nil
...
func (x *HookEntityId) GetAccountId() *AccountID {
	if x != nil {
		if x, ok := x.EntityId.(*HookEntityId_AccountId); ok {
			return x.AccountId
		}
	}
	return nil
...
type HookEntityId_AccountId struct {
	// *
	// An account using a hook.
	AccountId *AccountID `protobuf:"bytes,1,opt,name=account_id,json=accountId,proto3,oneof"`
}

type HookEntityId_ContractId struct {
	// *
	// A contract using a hook.
	ContractId *ContractID `protobuf:"bytes,2,opt,name=contract_id,json=contractId,proto3,oneof"`
}
...
type HookCall struct {
	...
	//
	//	*HookCall_HookId
	Id isHookCall_Id `protobuf_oneof:"id"`
	// *
	// Specifies details of the call.
	//
	// Types that are valid to be assigned to CallSpec:
	//
	//	*HookCall_EvmHookCall
	CallSpec      isHookCall_CallSpec `protobuf_oneof:"call_spec"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *HookCall) GetId() isHookCall_Id {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *HookCall) GetHookId() int64 {
	if x != nil {
		if x, ok := x.Id.(*HookCall_HookId); ok {
			return x.HookId
		}
	}
	return 0
...
func (x *HookCall) GetCallSpec() isHookCall_CallSpec {
	if x != nil {
		return x.CallSpec
	}
	return nil
...
func (x *HookCall) GetEvmHookCall() *EvmHookCall {
	if x != nil {
		if x, ok := x.CallSpec.(*HookCall_EvmHookCall); ok {
			return x.EvmHookCall
		}
	}
	return nil
}

type isHookCall_Id interface {
	isHookCall_Id()
}

type HookCall_HookId struct {
	// *
	// The numeric id of the hook to call, when the owning entity is forced by the call site.
	HookId int64 `protobuf:"varint,1,opt,name=hook_id,json=hookId,proto3,oneof"`
}

func (*HookCall_HookId) isHookCall_Id() {}

type isHookCall_CallSpec interface {
	isHookCall_CallSpec()
}

type HookCall_EvmHookCall struct {
	// *
	// Specification of how to call an EVM hook.
	EvmHookCall *EvmHookCall `protobuf:"bytes,3,opt,name=evm_hook_call,json=evmHookCall,proto3,oneof"`
}

func (*HookCall_EvmHookCall) isHookCall_CallSpec() {}
...
func (x *EvmHookCall) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EvmHookCall) ProtoMessage() {}

func (x *EvmHookCall) ProtoReflect() protoreflect.Message {
	mi := &file_basic_types_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EvmHookCall.ProtoReflect.Descriptor instead.
func (*EvmHookCall) Descriptor() ([]byte, []int) {
	return file_basic_types_proto_rawDescGZIP(), []int{13}
}

func (x *EvmHookCall) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *EvmHookCall) GetGasLimit() uint64 {
	if x != nil {
		return x.GasLimit
	}
	return 0
...
type AccountAmount struct {
	...
	//
	// Types that are valid to be assigned to HookCall:
	//
	//	*AccountAmount_PreTxAllowanceHook
	//	*AccountAmount_PrePostTxAllowanceHook
	HookCall      isAccountAmount_HookCall `protobuf_oneof:"hook_call"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AccountAmount) GetHookCall() isAccountAmount_HookCall {
	if x != nil {
		return x.HookCall
	}
	return nil
...
func (x *AccountAmount) GetPreTxAllowanceHook() *HookCall {
	if x != nil {
		if x, ok := x.HookCall.(*AccountAmount_PreTxAllowanceHook); ok {
			return x.PreTxAllowanceHook
		}
	}
	return nil
}

func (x *AccountAmount) GetPrePostTxAllowanceHook() *HookCall {
	if x != nil {
		if x, ok := x.HookCall.(*AccountAmount_PrePostTxAllowanceHook); ok {
			return x.PrePostTxAllowanceHook
		}
	}
	return nil
}

type isAccountAmount_HookCall interface {
	isAccountAmount_HookCall()
}

type AccountAmount_PreTxAllowanceHook struct {
	// *
	...
	PreTxAllowanceHook *HookCall `protobuf:"bytes,4,opt,name=pre_tx_allowance_hook,json=preTxAllowanceHook,proto3,oneof"`
}

type AccountAmount_PrePostTxAllowanceHook struct {
	// *
	...
	PrePostTxAllowanceHook *HookCall `protobuf:"bytes,5,opt,name=pre_post_tx_allowance_hook,json=prePostTxAllowanceHook,proto3,oneof"`
}

func (*AccountAmount_PreTxAllowanceHook) isAccountAmount_HookCall() {}

func (*AccountAmount_PrePostTxAllowanceHook) isAccountAmount_HookCall() {}
...
type NftTransfer struct {
	...
	// Cannot be set if `is_approval` is true.
	//
	// Types that are valid to be assigned to SenderAllowanceHookCall:
	//
	//	*NftTransfer_PreTxSenderAllowanceHook
	//	*NftTransfer_PrePostTxSenderAllowanceHook
	SenderAllowanceHookCall isNftTransfer_SenderAllowanceHookCall `protobuf_oneof:"sender_allowance_hook_call"`
	// *
	// If set, a call to a hook of type `ACCOUNT_ALLOWANCE_HOOK` installed on
	...
	// requirement).
	//
	// Types that are valid to be assigned to ReceiverAllowanceHookCall:
	//
	//	*NftTransfer_PreTxReceiverAllowanceHook
	//	*NftTransfer_PrePostTxReceiverAllowanceHook
	ReceiverAllowanceHookCall isNftTransfer_ReceiverAllowanceHookCall `protobuf_oneof:"receiver_allowance_hook_call"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
func (x *NftTransfer) GetSenderAllowanceHookCall() isNftTransfer_SenderAllowanceHookCall {
	if x != nil {
		return x.SenderAllowanceHookCall
	}
	return nil
}

func (x *NftTransfer) GetPreTxSenderAllowanceHook() *HookCall {
	if x != nil {
		if x, ok := x.SenderAllowanceHookCall.(*NftTransfer_PreTxSenderAllowanceHook); ok {
			return x.PreTxSenderAllowanceHook
		}
	}
	return nil
}

func (x *NftTransfer) GetPrePostTxSenderAllowanceHook() *HookCall {
	if x != nil {
		if x, ok := x.SenderAllowanceHookCall.(*NftTransfer_PrePostTxSenderAllowanceHook); ok {
			return x.PrePostTxSenderAllowanceHook
		}
	}
	return nil
}

func (x *NftTransfer) GetReceiverAllowanceHookCall() isNftTransfer_ReceiverAllowanceHookCall {
	if x != nil {
		return x.ReceiverAllowanceHookCall
	}
	return nil
}

func (x *NftTransfer) GetPreTxReceiverAllowanceHook() *HookCall {
	if x != nil {
		if x, ok := x.ReceiverAllowanceHookCall.(*NftTransfer_PreTxReceiverAllowanceHook); ok {
			return x.PreTxReceiverAllowanceHook
		}
	}
	return nil
}

func (x *NftTransfer) GetPrePostTxReceiverAllowanceHook() *HookCall {
	if x != nil {
		if x, ok := x.ReceiverAllowanceHookCall.(*NftTransfer_PrePostTxReceiverAllowanceHook); ok {
			return x.PrePostTxReceiverAllowanceHook
		}
	}
	return nil
}

type isNftTransfer_SenderAllowanceHookCall interface {
	isNftTransfer_SenderAllowanceHookCall()
}

type NftTransfer_PreTxSenderAllowanceHook struct {
	// *
	// A single call made before attempting the CryptoTransfer, to a
	// method with logical signature allow(HookContext, ProposedTransfers)
	PreTxSenderAllowanceHook *HookCall `protobuf:"bytes,5,opt,name=pre_tx_sender_allowance_hook,json=preTxSenderAllowanceHook,proto3,oneof"`
}

type NftTransfer_PrePostTxSenderAllowanceHook struct {
	// *
	// Two calls, the first call before attempting the CryptoTransfer, to a
	// method with logical signature allowPre(HookContext, ProposedTransfers);
	// and the second call after attempting the CryptoTransfer, to a method
	// with logical signature allowPost(HookContext, ProposedTransfers).
	PrePostTxSenderAllowanceHook *HookCall `protobuf:"bytes,6,opt,name=pre_post_tx_sender_allowance_hook,json=prePostTxSenderAllowanceHook,proto3,oneof"`
}

func (*NftTransfer_PreTxSenderAllowanceHook) isNftTransfer_SenderAllowanceHookCall() {}

func (*NftTransfer_PrePostTxSenderAllowanceHook) isNftTransfer_SenderAllowanceHookCall() {}

type isNftTransfer_ReceiverAllowanceHookCall interface {
	isNftTransfer_ReceiverAllowanceHookCall()
}

type NftTransfer_PreTxReceiverAllowanceHook struct {
	// *
	// A single call made before attempting the CryptoTransfer, to a
	// method with logical signature allow(HookContext, ProposedTransfers)
	PreTxReceiverAllowanceHook *HookCall `protobuf:"bytes,7,opt,name=pre_tx_receiver_allowance_hook,json=preTxReceiverAllowanceHook,proto3,oneof"`
}

type NftTransfer_PrePostTxReceiverAllowanceHook struct {
	// *
	// Two calls, the first call before attempting the CryptoTransfer, to a
	// method with logical signature allowPre(HookContext, ProposedTransfers);
	// and the second call after attempting the CryptoTransfer, to a method
	// with logical signature allowPost(HookContext, ProposedTransfers).
	PrePostTxReceiverAllowanceHook *HookCall `protobuf:"bytes,8,opt,name=pre_post_tx_receiver_allowance_hook,json=prePostTxReceiverAllowanceHook,proto3,oneof"`
}

func (*NftTransfer_PreTxReceiverAllowanceHook) isNftTransfer_ReceiverAllowanceHookCall() {}

func (*NftTransfer_PrePostTxReceiverAllowanceHook) isNftTransfer_ReceiverAllowanceHookCall() {}
...
func (x *PendingAirdropId) Reset() {
	*x = PendingAirdropId{}
	mi := &file_basic_types_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PendingAirdropId) Descriptor() ([]byte, []int) {
	return file_basic_types_proto_rawDescGZIP(), []int{43}
}
...
func (x *PendingAirdropValue) Reset() {
	*x = PendingAirdropValue{}
	mi := &file_basic_types_proto_msgTypes[44]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PendingAirdropValue) Descriptor() ([]byte, []int) {
	return file_basic_types_proto_rawDescGZIP(), []int{44}
}
...
const file_basic_types_proto_rawDesc = "" +
	...
	"\x05nonce\x18\x04 \x01(\x05R\x05nonce\"S\n" +
	"\x06HookId\x120\n" +
	"\tentity_id\x18\x01 \x01(\v2\x13.proto.HookEntityIdR\bentityId\x12\x17\n" +
	"\ahook_id\x18\x02 \x01(\x03R\x06hookId\"\x84\x01\n" +
	"\fHookEntityId\x121\n" +
	"\n" +
	"account_id\x18\x01 \x01(\v2\x10.proto.AccountIDH\x00R\taccountId\x124\n" +
	"\vcontract_id\x18\x02 \x01(\v2\x11.proto.ContractIDH\x00R\n" +
	"contractIdB\v\n" +
	"\tentity_id\"r\n" +
	"\bHookCall\x12\x19\n" +
	"\ahook_id\x18\x01 \x01(\x03H\x00R\x06hookId\x128\n" +
	"\revm_hook_call\x18\x03 \x01(\v2\x12.proto.EvmHookCallH\x01R\vevmHookCallB\x04\n" +
	"\x02idB\v\n" +
	"\tcall_spec\">\n" +
	"\vEvmHookCall\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\x12\x1b\n" +
	"\tgas_limit\x18\x02 \x01(\x04R\bgasLimit\"\x9a\x02\n" +
	"\rAccountAmount\x12.\n" +
	...
	"isApproval\x12D\n" +
	"\x15pre_tx_allowance_hook\x18\x04 \x01(\v2\x0f.proto.HookCallH\x00R\x12preTxAllowanceHook\x12M\n" +
	"\x1apre_post_tx_allowance_hook\x18\x05 \x01(\v2\x0f.proto.HookCallH\x00R\x16prePostTxAllowanceHookB\v\n" +
	"\thook_call\"L\n" +
	"\fTransferList\x12<\n" +
	"\x0eaccountAmounts\x18\x01 \x03(\v2\x14.proto.AccountAmountR\x0eaccountAmounts\"\xf2\x04\n" +
	"\vNftTransfer\x12:\n" +
	...
	"isApproval\x12Q\n" +
	"\x1cpre_tx_sender_allowance_hook\x18\x05 \x01(\v2\x0f.proto.HookCallH\x00R\x18preTxSenderAllowanceHook\x12Z\n" +
	"!pre_post_tx_sender_allowance_hook\x18\x06 \x01(\v2\x0f.proto.HookCallH\x00R\x1cprePostTxSenderAllowanceHook\x12U\n" +
	"\x1epre_tx_receiver_allowance_hook\x18\a \x01(\v2\x0f.proto.HookCallH\x01R\x1apreTxReceiverAllowanceHook\x12^\n" +
	"#pre_post_tx_receiver_allowance_hook\x18\b \x01(\v2\x0f.proto.HookCallH\x01R\x1eprePostTxReceiverAllowanceHookB\x1c\n" +
	"\x1asender_allowance_hook_callB\x1e\n" +
	"\x1creceiver_allowance_hook_call\"\xf0\x01\n" +
	...
	"\x13NON_FUNGIBLE_UNIQUE\x10\x01*\xb7\x02\n" +
	"\aSubType\x12\v\n" +
	...
	"\x1fSUBMIT_MESSAGE_WITH_CUSTOM_FEES\x10\a\x12\x1e\n" +
	"\x1aCRYPTO_TRANSFER_WITH_HOOKS\x10\b*+\n" +
...
var file_basic_types_proto_msgTypes = make([]protoimpl.MessageInfo, 45)
var file_basic_types_proto_goTypes = []any{
	...
	(*HookId)(nil),                    // 19: proto.HookId
	(*HookEntityId)(nil),              // 20: proto.HookEntityId
	(*HookCall)(nil),                  // 21: proto.HookCall
	(*EvmHookCall)(nil),               // 22: proto.EvmHookCall
	(*AccountAmount)(nil),             // 23: proto.AccountAmount
	(*TransferList)(nil),              // 24: proto.TransferList
	(*NftTransfer)(nil),               // 25: proto.NftTransfer
	(*TokenTransferList)(nil),         // 26: proto.TokenTransferList
	(*Fraction)(nil),                  // 27: proto.Fraction
	(*Key)(nil),                       // 28: proto.Key
	(*ThresholdKey)(nil),              // 29: proto.ThresholdKey
	(*KeyList)(nil),                   // 30: proto.KeyList
	(*Signature)(nil),                 // 31: proto.Signature
	(*ThresholdSignature)(nil),        // 32: proto.ThresholdSignature
	(*SignatureList)(nil),             // 33: proto.SignatureList
	(*SignaturePair)(nil),             // 34: proto.SignaturePair
	(*SignatureMap)(nil),              // 35: proto.SignatureMap
	(*FeeComponents)(nil),             // 36: proto.FeeComponents
	(*TransactionFeeSchedule)(nil),    // 37: proto.TransactionFeeSchedule
	(*FeeData)(nil),                   // 38: proto.FeeData
	(*FeeSchedule)(nil),               // 39: proto.FeeSchedule
	(*CurrentAndNextFeeSchedule)(nil), // 40: proto.CurrentAndNextFeeSchedule
	(*ServiceEndpoint)(nil),           // 41: proto.ServiceEndpoint
	(*NodeAddress)(nil),               // 42: proto.NodeAddress
	(*NodeAddressBook)(nil),           // 43: proto.NodeAddressBook
	(*SemanticVersion)(nil),           // 44: proto.SemanticVersion
	(*Setting)(nil),                   // 45: proto.Setting
	(*ServicesConfigurationList)(nil), // 46: proto.ServicesConfigurationList
	(*TokenRelationship)(nil),         // 47: proto.TokenRelationship
	(*TokenBalance)(nil),              // 48: proto.TokenBalance
	(*TokenBalances)(nil),             // 49: proto.TokenBalances
	(*TokenAssociation)(nil),          // 50: proto.TokenAssociation
	(*StakingInfo)(nil),               // 51: proto.StakingInfo
	(*PendingAirdropId)(nil),          // 52: proto.PendingAirdropId
	(*PendingAirdropValue)(nil),       // 53: proto.PendingAirdropValue
	(*Timestamp)(nil),                 // 54: proto.Timestamp
	(*wrapperspb.UInt32Value)(nil),    // 55: google.protobuf.UInt32Value
	(*TimestampSeconds)(nil),          // 56: proto.TimestampSeconds
}
var file_basic_types_proto_depIdxs = []int32{
	11, // 0: proto.NftID.token_ID:type_name -> proto.TokenID
	54, // 1: proto.TransactionID.transactionValidStart:type_name -> proto.Timestamp
	12, // 2: proto.TransactionID.accountID:type_name -> proto.AccountID
	20, // 3: proto.HookId.entity_id:type_name -> proto.HookEntityId
	12, // 4: proto.HookEntityId.account_id:type_name -> proto.AccountID
	15, // 5: proto.HookEntityId.contract_id:type_name -> proto.ContractID
	22, // 6: proto.HookCall.evm_hook_call:type_name -> proto.EvmHookCall
	12, // 7: proto.AccountAmount.accountID:type_name -> proto.AccountID
	21, // 8: proto.AccountAmount.pre_tx_allowance_hook:type_name -> proto.HookCall
	21, // 9: proto.AccountAmount.pre_post_tx_allowance_hook:type_name -> proto.HookCall
	23, // 10: proto.TransferList.accountAmounts:type_name -> proto.AccountAmount
	12, // 11: proto.NftTransfer.senderAccountID:type_name -> proto.AccountID
	12, // 12: proto.NftTransfer.receiverAccountID:type_name -> proto.AccountID
	21, // 13: proto.NftTransfer.pre_tx_sender_allowance_hook:type_name -> proto.HookCall
	21, // 14: proto.NftTransfer.pre_post_tx_sender_allowance_hook:type_name -> proto.HookCall
	21, // 15: proto.NftTransfer.pre_tx_receiver_allowance_hook:type_name -> proto.HookCall
	21, // 16: proto.NftTransfer.pre_post_tx_receiver_allowance_hook:type_name -> proto.HookCall
	11, // 17: proto.TokenTransferList.token:type_name -> proto.TokenID
	23, // 18: proto.TokenTransferList.transfers:type_name -> proto.AccountAmount
	25, // 19: proto.TokenTransferList.nftTransfers:type_name -> proto.NftTransfer
	55, // 20: proto.TokenTransferList.expected_decimals:type_name -> google.protobuf.UInt32Value
	15, // 21: proto.Key.contractID:type_name -> proto.ContractID
	29, // 22: proto.Key.thresholdKey:type_name -> proto.ThresholdKey
	30, // 23: proto.Key.keyList:type_name -> proto.KeyList
	15, // 24: proto.Key.delegatable_contract_id:type_name -> proto.ContractID
	30, // 25: proto.ThresholdKey.keys:type_name -> proto.KeyList
	28, // 26: proto.KeyList.keys:type_name -> proto.Key
	32, // 27: proto.Signature.thresholdSignature:type_name -> proto.ThresholdSignature
	33, // 28: proto.Signature.signatureList:type_name -> proto.SignatureList
	33, // 29: proto.ThresholdSignature.sigs:type_name -> proto.SignatureList
	31, // 30: proto.SignatureList.sigs:type_name -> proto.Signature
	34, // 31: proto.SignatureMap.sigPair:type_name -> proto.SignaturePair
	8,  // 32: proto.TransactionFeeSchedule.hederaFunctionality:type_name -> proto.HederaFunctionality
	38, // 33: proto.TransactionFeeSchedule.feeData:type_name -> proto.FeeData
	38, // 34: proto.TransactionFeeSchedule.fees:type_name -> proto.FeeData
	36, // 35: proto.FeeData.nodedata:type_name -> proto.FeeComponents
	36, // 36: proto.FeeData.networkdata:type_name -> proto.FeeComponents
	36, // 37: proto.FeeData.servicedata:type_name -> proto.FeeComponents
	2,  // 38: proto.FeeData.subType:type_name -> proto.SubType
	37, // 39: proto.FeeSchedule.transactionFeeSchedule:type_name -> proto.TransactionFeeSchedule
	56, // 40: proto.FeeSchedule.expiryTime:type_name -> proto.TimestampSeconds
	39, // 41: proto.CurrentAndNextFeeSchedule.currentFeeSchedule:type_name -> proto.FeeSchedule
	39, // 42: proto.CurrentAndNextFeeSchedule.nextFeeSchedule:type_name -> proto.FeeSchedule
	12, // 43: proto.NodeAddress.nodeAccountId:type_name -> proto.AccountID
	41, // 44: proto.NodeAddress.serviceEndpoint:type_name -> proto.ServiceEndpoint
	42, // 45: proto.NodeAddressBook.nodeAddress:type_name -> proto.NodeAddress
	45, // 46: proto.ServicesConfigurationList.nameValue:type_name -> proto.Setting
	11, // 47: proto.TokenRelationship.tokenId:type_name -> proto.TokenID
	6,  // 48: proto.TokenRelationship.kycStatus:type_name -> proto.TokenKycStatus
	5,  // 49: proto.TokenRelationship.freezeStatus:type_name -> proto.TokenFreezeStatus
	11, // 50: proto.TokenBalance.tokenId:type_name -> proto.TokenID
	48, // 51: proto.TokenBalances.tokenBalances:type_name -> proto.TokenBalance
	11, // 52: proto.TokenAssociation.token_id:type_name -> proto.TokenID
	12, // 53: proto.TokenAssociation.account_id:type_name -> proto.AccountID
	54, // 54: proto.StakingInfo.stake_period_start:type_name -> proto.Timestamp
	12, // 55: proto.StakingInfo.staked_account_id:type_name -> proto.AccountID
	12, // 56: proto.PendingAirdropId.sender_id:type_name -> proto.AccountID
	12, // 57: proto.PendingAirdropId.receiver_id:type_name -> proto.AccountID
	11, // 58: proto.PendingAirdropId.fungible_token_type:type_name -> proto.TokenID
	13, // 59: proto.PendingAirdropId.non_fungible_token:type_name -> proto.NftID
...
func file_basic_types_proto_init() {
	...
	file_basic_types_proto_msgTypes[11].OneofWrappers = []any{
		(*HookEntityId_AccountId)(nil),
		(*HookEntityId_ContractId)(nil),
	}
	file_basic_types_proto_msgTypes[12].OneofWrappers = []any{
		(*HookCall_HookId)(nil),
		(*HookCall_EvmHookCall)(nil),
	}
	file_basic_types_proto_msgTypes[14].OneofWrappers = []any{
		(*AccountAmount_PreTxAllowanceHook)(nil),
		(*AccountAmount_PrePostTxAllowanceHook)(nil),
	}
	file_basic_types_proto_msgTypes[16].OneofWrappers = []any{
		(*NftTransfer_PreTxSenderAllowanceHook)(nil),
		(*NftTransfer_PrePostTxSenderAllowanceHook)(nil),
		(*NftTransfer_PreTxReceiverAllowanceHook)(nil),
		(*NftTransfer_PrePostTxReceiverAllowanceHook)(nil),
	}
	file_basic_types_proto_msgTypes[19].OneofWrappers = []any{
		(*Key_ContractID)(nil),
		(*Key_Ed25519)(nil),
		(*Key_RSA_3072)(nil),
		(*Key_ECDSA_384)(nil),
	...
	file_basic_types_proto_msgTypes[22].OneofWrappers = []any{
	...
	file_basic_types_proto_msgTypes[25].OneofWrappers = []any{
	...
	file_basic_types_proto_msgTypes[42].OneofWrappers = []any{
		(*StakingInfo_StakedAccountId)(nil),
		(*StakingInfo_StakedNodeId)(nil),
	}
	file_basic_types_proto_msgTypes[43].OneofWrappers = []any{
