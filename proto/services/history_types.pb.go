...
const file_history_types_proto_rawDesc = "" +
	"\n" +
	"\x13history_types.proto\x12\"com.hedera.hapi.node.state.history\x1a\x0ftimestamp.proto\x1a\x1achain_of_trust_proof.proto\"q\n" +
	"\vProofKeySet\x125\n" +
...
func file_history_types_proto_init() {
	...
	file_chain_of_trust_proof_proto_init()
