...
var file_smart_contract_service_proto_depIdxs = []int32{
	...
	3,  // 17: proto.SmartContractService.getContractInfo:output_type -> proto.Response
	3,  // 18: proto.SmartContractService.ContractGetBytecode:output_type -> proto.Response
	3,  // 19: proto.SmartContractService.getBySolidityID:output_type -> proto.Response
	3,  // 20: proto.SmartContractService.getTxRecordByContractID:output_type -> proto.Response
	2,  // 21: proto.SmartContractService.deleteContract:output_type -> proto.TransactionResponse
