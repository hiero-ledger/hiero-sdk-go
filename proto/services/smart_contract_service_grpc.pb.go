...
func (UnimplementedSmartContractServiceServer) ContractCallMethod(context.Context, *Transaction) (*TransactionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ContractCallMethod not implemented")
}
func (UnimplementedSmartContractServiceServer) ContractCallLocalMethod(context.Context, *Query) (*Response, error) {
	return nil, status.Error(codes.Unimplemented, "method ContractCallLocalMethod not implemented")
}
...
func (UnimplementedSmartContractServiceServer) ContractGetBytecode(context.Context, *Query) (*Response, error) {
	return nil, status.Error(codes.Unimplemented, "method ContractGetBytecode not implemented")
}
func (UnimplementedSmartContractServiceServer) GetBySolidityID(context.Context, *Query) (*Response, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBySolidityID not implemented")
}
func (UnimplementedSmartContractServiceServer) GetTxRecordByContractID(context.Context, *Query) (*Response, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTxRecordByContractID not implemented")
}
...
func (UnimplementedSmartContractServiceServer) SystemUndelete(context.Context, *Transaction) (*TransactionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SystemUndelete not implemented")
}
func (UnimplementedSmartContractServiceServer) CallEthereum(context.Context, *Transaction) (*TransactionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CallEthereum not implemented")
}
func (UnimplementedSmartContractServiceServer) HookStore(context.Context, *Transaction) (*TransactionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method HookStore not implemented")
}
