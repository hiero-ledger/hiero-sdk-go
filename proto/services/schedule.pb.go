...
const file_schedule_proto_rawDesc = "" +
	"\n" +
	"\x0eschedule.proto\x12\x05proto\x1a\x11basic_types.proto\x1a\x0ftimestamp.proto\x1a\"schedulable_transaction_body.proto\x1a\x11transaction.proto\"\xb6\x06\n" +
	"\bSchedule\x122\n" +
	...
	"\forder_number\x18\x02 \x01(\rR\vorderNumberB&\n" +
