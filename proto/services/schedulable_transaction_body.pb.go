...
type SchedulableTransactionBody struct {
	...
	//	*SchedulableTransactionBody_RegisteredNodeCreate
	//	*SchedulableTransactionBody_RegisteredNodeUpdate
	//	*SchedulableTransactionBody_RegisteredNodeDelete
...
func (x *SchedulableTransactionBody) GetRegisteredNodeCreate() *RegisteredNodeCreateTransactionBody {
	if x != nil {
		if x, ok := x.Data.(*SchedulableTransactionBody_RegisteredNodeCreate); ok {
			return x.RegisteredNodeCreate
		}
	}
	return nil
}

func (x *SchedulableTransactionBody) GetRegisteredNodeUpdate() *RegisteredNodeUpdateTransactionBody {
	if x != nil {
		if x, ok := x.Data.(*SchedulableTransactionBody_RegisteredNodeUpdate); ok {
			return x.RegisteredNodeUpdate
		}
	}
	return nil
}

func (x *SchedulableTransactionBody) GetRegisteredNodeDelete() *RegisteredNodeDeleteTransactionBody {
	if x != nil {
		if x, ok := x.Data.(*SchedulableTransactionBody_RegisteredNodeDelete); ok {
			return x.RegisteredNodeDelete
		}
	}
	return nil
}
...
type SchedulableTransactionBody_RegisteredNodeCreate struct {
	// *
	// Create a new registered node in the network address book.
	RegisteredNodeCreate *RegisteredNodeCreateTransactionBody `protobuf:"bytes,49,opt,name=registeredNodeCreate,proto3,oneof"`
}

type SchedulableTransactionBody_RegisteredNodeUpdate struct {
	// *
	// Update a registered node in the network address book.
	RegisteredNodeUpdate *RegisteredNodeUpdateTransactionBody `protobuf:"bytes,50,opt,name=registeredNodeUpdate,proto3,oneof"`
}

type SchedulableTransactionBody_RegisteredNodeDelete struct {
	// *
	// Delete a registered node from the network address book.
	RegisteredNodeDelete *RegisteredNodeDeleteTransactionBody `protobuf:"bytes,51,opt,name=registeredNodeDelete,proto3,oneof"`
}
...
func (*SchedulableTransactionBody_RegisteredNodeCreate) isSchedulableTransactionBody_Data() {}

func (*SchedulableTransactionBody_RegisteredNodeUpdate) isSchedulableTransactionBody_Data() {}

func (*SchedulableTransactionBody_RegisteredNodeDelete) isSchedulableTransactionBody_Data() {}
...
const file_schedulable_transaction_body_proto_rawDesc = "" +
	...
	"\x14registeredNodeCreate\x181 \x01(\v2E.com.hedera.hapi.node.addressbook.RegisteredNodeCreateTransactionBodyH\x00R\x14registeredNodeCreate\x12{\n" +
	"\x14registeredNodeUpdate\x182 \x01(\v2E.com.hedera.hapi.node.addressbook.RegisteredNodeUpdateTransactionBodyH\x00R\x14registeredNodeUpdate\x12{\n" +
	"\x14registeredNodeDelete\x183 \x01(\v2E.com.hedera.hapi.node.addressbook.RegisteredNodeDeleteTransactionBodyH\x00R\x14registeredNodeDelete\x12>\n" +
...
var file_schedulable_transaction_body_proto_goTypes = []any{
	...
	(*RegisteredNodeCreateTransactionBody)(nil),   // 47: com.hedera.hapi.node.addressbook.RegisteredNodeCreateTransactionBody
	(*RegisteredNodeUpdateTransactionBody)(nil),   // 48: com.hedera.hapi.node.addressbook.RegisteredNodeUpdateTransactionBody
	(*RegisteredNodeDeleteTransactionBody)(nil),   // 49: com.hedera.hapi.node.addressbook.RegisteredNodeDeleteTransactionBody
	(*CustomFeeLimit)(nil),                        // 50: proto.CustomFeeLimit
}
var file_schedulable_transaction_body_proto_depIdxs = []int32{
	...
	47, // 46: proto.SchedulableTransactionBody.registeredNodeCreate:type_name -> com.hedera.hapi.node.addressbook.RegisteredNodeCreateTransactionBody
	48, // 47: proto.SchedulableTransactionBody.registeredNodeUpdate:type_name -> com.hedera.hapi.node.addressbook.RegisteredNodeUpdateTransactionBody
	49, // 48: proto.SchedulableTransactionBody.registeredNodeDelete:type_name -> com.hedera.hapi.node.addressbook.RegisteredNodeDeleteTransactionBody
	50, // 49: proto.SchedulableTransactionBody.max_custom_fees:type_name -> proto.CustomFeeLimit
...
func file_schedulable_transaction_body_proto_init() {
	...
	file_registered_node_update_proto_init()
	file_registered_node_delete_proto_init()
	file_schedulable_transaction_body_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*SchedulableTransactionBody_RegisteredNodeCreate)(nil),
		(*SchedulableTransactionBody_RegisteredNodeUpdate)(nil),
		(*SchedulableTransactionBody_RegisteredNodeDelete)(nil),
	}
	type x struct{}
