...
type NodeUpdateTransactionBody struct {
	...
	AssociatedRegisteredNodeList *AssociatedRegisteredNodeList `protobuf:"bytes,11,opt,name=associated_registered_node_list,json=associatedRegisteredNodeList,proto3" json:"associated_registered_node_list,omitempty"`
...
func (x *NodeUpdateTransactionBody) GetAssociatedRegisteredNodeList() *AssociatedRegisteredNodeList {
	if x != nil {
		return x.AssociatedRegisteredNodeList
	}
	return nil
}
...
// existing values.
type AssociatedRegisteredNodeList struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// *
	// A list of registered node identifiers.
	AssociatedRegisteredNode []uint64 `protobuf:"varint,1,rep,packed,name=associated_registered_node,json=associatedRegisteredNode,proto3" json:"associated_registered_node,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}

func (x *AssociatedRegisteredNodeList) Reset() {
	*x = AssociatedRegisteredNodeList{}
	mi := &file_node_update_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AssociatedRegisteredNodeList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AssociatedRegisteredNodeList) ProtoMessage() {}

func (x *AssociatedRegisteredNodeList) ProtoReflect() protoreflect.Message {
	mi := &file_node_update_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AssociatedRegisteredNodeList.ProtoReflect.Descriptor instead.
func (*AssociatedRegisteredNodeList) Descriptor() ([]byte, []int) {
	return file_node_update_proto_rawDescGZIP(), []int{1}
}

func (x *AssociatedRegisteredNodeList) GetAssociatedRegisteredNode() []uint64 {
	if x != nil {
...
const file_node_update_proto_rawDesc = "" +
	"\n" +
	"\x11node_update.proto\x12 com.hedera.hapi.node.addressbook\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x11basic_types.proto\"\x87\x06\n" +
	...
	" \x01(\v2\x16.proto.ServiceEndpointR\x11grpcProxyEndpoint\x12\x85\x01\n" +
	"\x1fassociated_registered_node_list\x18\v \x01(\v2>.com.hedera.hapi.node.addressbook.AssociatedRegisteredNodeListR\x1cassociatedRegisteredNodeList\"\\\n" +
	"\x1cAssociatedRegisteredNodeList\x12<\n" +
	"\x1aassociated_registered_node\x18\x01 \x03(\x04R\x18associatedRegisteredNodeB&\n" +
...
var file_node_update_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_node_update_proto_goTypes = []any{
	...
	(*AssociatedRegisteredNodeList)(nil), // 1: com.hedera.hapi.node.addressbook.AssociatedRegisteredNodeList
	(*AccountID)(nil),                    // 2: proto.AccountID
	(*wrapperspb.StringValue)(nil),       // 3: google.protobuf.StringValue
	(*ServiceEndpoint)(nil),              // 4: proto.ServiceEndpoint
...
var file_node_update_proto_depIdxs = []int32{
	2,  // 0: com.hedera.hapi.node.addressbook.NodeUpdateTransactionBody.account_id:type_name -> proto.AccountID
	3,  // 1: com.hedera.hapi.node.addressbook.NodeUpdateTransactionBody.description:type_name -> google.protobuf.StringValue
	4,  // 2: com.hedera.hapi.node.addressbook.NodeUpdateTransactionBody.gossip_endpoint:type_name -> proto.ServiceEndpoint
	4,  // 3: com.hedera.hapi.node.addressbook.NodeUpdateTransactionBody.service_endpoint:type_name -> proto.ServiceEndpoint
	5,  // 4: com.hedera.hapi.node.addressbook.NodeUpdateTransactionBody.gossip_ca_certificate:type_name -> google.protobuf.BytesValue
	5,  // 5: com.hedera.hapi.node.addressbook.NodeUpdateTransactionBody.grpc_certificate_hash:type_name -> google.protobuf.BytesValue
	6,  // 6: com.hedera.hapi.node.addressbook.NodeUpdateTransactionBody.admin_key:type_name -> proto.Key
	7,  // 7: com.hedera.hapi.node.addressbook.NodeUpdateTransactionBody.decline_reward:type_name -> google.protobuf.BoolValue
	4,  // 8: com.hedera.hapi.node.addressbook.NodeUpdateTransactionBody.grpc_proxy_endpoint:type_name -> proto.ServiceEndpoint
	1,  // 9: com.hedera.hapi.node.addressbook.NodeUpdateTransactionBody.associated_registered_node_list:type_name -> com.hedera.hapi.node.addressbook.AssociatedRegisteredNodeList
