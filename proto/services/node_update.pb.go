...
type NodeUpdateTransactionBody struct {
	...
	// <p>
	// If set, the new list SHALL replace the existing list.
	AssociatedRegisteredNode []uint64 `protobuf:"varint,11,rep,packed,name=associated_registered_node,json=associatedRegisteredNode,proto3" json:"associated_registered_node,omitempty"`
...
func (x *NodeUpdateTransactionBody) GetAssociatedRegisteredNode() []uint64 {
	if x != nil {
...
const file_node_update_proto_rawDesc = "" +
	"\n" +
	"\x11node_update.proto\x12 com.hedera.hapi.node.addressbook\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x11basic_types.proto\"\xbd\x05\n" +
	...
	" \x01(\v2\x16.proto.ServiceEndpointR\x11grpcProxyEndpoint\x12<\n" +
	"\x1aassociated_registered_node\x18\v \x03(\x04R\x18associatedRegisteredNodeB&\n" +
