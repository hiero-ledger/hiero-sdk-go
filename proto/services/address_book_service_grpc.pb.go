...
const (
	...
	AddressBookService_CreateRegisteredNode_FullMethodName = "/proto.AddressBookService/createRegisteredNode"
	AddressBookService_DeleteRegisteredNode_FullMethodName = "/proto.AddressBookService/deleteRegisteredNode"
	AddressBookService_UpdateRegisteredNode_FullMethodName = "/proto.AddressBookService/updateRegisteredNode"
)
...
type AddressBookServiceClient interface {
	...
	CreateRegisteredNode(ctx context.Context, in *Transaction, opts ...grpc.CallOption) (*TransactionResponse, error)
	// *
	...
	DeleteRegisteredNode(ctx context.Context, in *Transaction, opts ...grpc.CallOption) (*TransactionResponse, error)
	// *
	...
	// node state as requested.
	UpdateRegisteredNode(ctx context.Context, in *Transaction, opts ...grpc.CallOption) (*TransactionResponse, error)
}
...
func (c *addressBookServiceClient) CreateRegisteredNode(ctx context.Context, in *Transaction, opts ...grpc.CallOption) (*TransactionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TransactionResponse)
	err := c.cc.Invoke(ctx, AddressBookService_CreateRegisteredNode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *addressBookServiceClient) DeleteRegisteredNode(ctx context.Context, in *Transaction, opts ...grpc.CallOption) (*TransactionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TransactionResponse)
	err := c.cc.Invoke(ctx, AddressBookService_DeleteRegisteredNode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *addressBookServiceClient) UpdateRegisteredNode(ctx context.Context, in *Transaction, opts ...grpc.CallOption) (*TransactionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TransactionResponse)
	err := c.cc.Invoke(ctx, AddressBookService_UpdateRegisteredNode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AddressBookServiceServer interface {
	...
	// The new registered node SHALL be visible and discoverable upon
	// completion of this transaction.
	CreateRegisteredNode(context.Context, *Transaction) (*TransactionResponse, error)
	// *
	// A transaction to remove a registered node from the network address
	// book.
	// <p>
	...
	// This transaction MUST be signed by the existing entry `admin_key` or
	// authorized by the Hiero network governance structure.
	DeleteRegisteredNode(context.Context, *Transaction) (*TransactionResponse, error)
	// *
	// A transaction to update an existing registered node in the network
	// address book.
	// <p>
	// This transaction, once complete, SHALL modify the identified registered
	// node state as requested.
	UpdateRegisteredNode(context.Context, *Transaction) (*TransactionResponse, error)
...
func (UnimplementedAddressBookServiceServer) CreateRegisteredNode(context.Context, *Transaction) (*TransactionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateRegisteredNode not implemented")
}
func (UnimplementedAddressBookServiceServer) DeleteRegisteredNode(context.Context, *Transaction) (*TransactionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteRegisteredNode not implemented")
}
func (UnimplementedAddressBookServiceServer) UpdateRegisteredNode(context.Context, *Transaction) (*TransactionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateRegisteredNode not implemented")
}
...
func RegisterAddressBookServiceServer(s grpc.ServiceRegistrar, srv AddressBookServiceServer) {
	// If the following call panics, it indicates UnimplementedAddressBookServiceServer was
...
func _AddressBookService_CreateRegisteredNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Transaction)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddressBookServiceServer).CreateRegisteredNode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AddressBookService_CreateRegisteredNode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddressBookServiceServer).CreateRegisteredNode(ctx, req.(*Transaction))
	}
	return interceptor(ctx, in, info, handler)
}

func _AddressBookService_DeleteRegisteredNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Transaction)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddressBookServiceServer).DeleteRegisteredNode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AddressBookService_DeleteRegisteredNode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddressBookServiceServer).DeleteRegisteredNode(ctx, req.(*Transaction))
	}
	return interceptor(ctx, in, info, handler)
}

func _AddressBookService_UpdateRegisteredNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Transaction)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddressBookServiceServer).UpdateRegisteredNode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AddressBookService_UpdateRegisteredNode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddressBookServiceServer).UpdateRegisteredNode(ctx, req.(*Transaction))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AddressBookService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "createRegisteredNode",
			Handler:    _AddressBookService_CreateRegisteredNode_Handler,
		},
		{
			MethodName: "deleteRegisteredNode",
			Handler:    _AddressBookService_DeleteRegisteredNode_Handler,
		},
		{
			MethodName: "updateRegisteredNode",
			Handler:    _AddressBookService_UpdateRegisteredNode_Handler,
		},
	},
