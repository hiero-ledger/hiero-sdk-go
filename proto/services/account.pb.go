...
type Account struct {
	...
	NumberHooksInUse uint64 `protobuf:"varint,36,opt,name=number_hooks_in_use,json=numberHooksInUse,proto3" json:"number_hooks_in_use,omitempty"`
	// *
	// If the account has more than zero hooks in use, the id of the first hook in its
	// doubly-linked list of hooks.
	FirstHookId int64 `protobuf:"varint,37,opt,name=first_hook_id,json=firstHookId,proto3" json:"first_hook_id,omitempty"`
	// *
	// The number of storage slots in use by this account's EVM hooks.
	NumberEvmHookStorageSlots uint64 `protobuf:"varint,38,opt,name=number_evm_hook_storage_slots,json=numberEvmHookStorageSlots,proto3" json:"number_evm_hook_storage_slots,omitempty"`
...
func (x *Account) GetNumberHooksInUse() uint64 {
	if x != nil {
		return x.NumberHooksInUse
	}
	return 0
}

func (x *Account) GetFirstHookId() int64 {
	if x != nil {
		return x.FirstHookId
	}
	return 0
}

func (x *Account) GetNumberEvmHookStorageSlots() uint64 {
	if x != nil {
		return x.NumberEvmHookStorageSlots
	}
	return 0
}
...
const file_account_proto_rawDesc = "" +
	"\n" +
	"\raccount.proto\x12\x05proto\x1a\x11basic_types.proto\"\xcd\x0f\n" +
	"\aAccount\x12/\n" +
	"\n" +
	...
	"\x17number_pending_airdrops\x18# \x01(\x04R\x15numberPendingAirdrops\x12-\n" +
	"\x13number_hooks_in_use\x18$ \x01(\x04R\x10numberHooksInUse\x12\"\n" +
	"\rfirst_hook_id\x18% \x01(\x03R\vfirstHookId\x12@\n" +
	"\x1dnumber_evm_hook_storage_slots\x18& \x01(\x04R\x19numberEvmHookStorageSlotsB\v\n" +
	"\tstaked_id\"|\n" +
