...
type TransactionRecord struct {
	...
	HighVolumePricingMultiplier uint64 `protobuf:"varint,23,opt,name=high_volume_pricing_multiplier,json=highVolumePricingMultiplier,proto3" json:"high_volume_pricing_multiplier,omitempty"`
...
func (x *TransactionRecord) GetHighVolumePricingMultiplier() uint64 {
	if x != nil {
		return x.HighVolumePricingMultiplier
	}
	return 0
}
...
const file_transaction_record_proto_rawDesc = "" +
	"\n" +
	"\x18transaction_record.proto\x12\x05proto\x1a\x0ftimestamp.proto\x1a\x11basic_types.proto\x1a\x11custom_fees.proto\x1a\x19transaction_receipt.proto\x1a\x14contract_types.proto\"\x90\n" +
	"\n" +
	...
	"evmAddress\x12M\n" +
	"\x14new_pending_airdrops\x18\x16 \x03(\v2\x1b.proto.PendingAirdropRecordR\x12newPendingAirdrops\x12C\n" +
	"\x1ehigh_volume_pricing_multiplier\x18\x17 \x01(\x04R\x1bhighVolumePricingMultiplierB\x06\n" +
	"\x04bodyB\t\n" +
	"\aentropy\"\xad\x01\n" +
