...
const file_consensus_service_proto_rawDesc = "" +
	"\n" +
	"\x17consensus_service.proto\x12\x1bcom.hedera.mirror.api.proto\x1a\x11basic_types.proto\x1a\x0ftimestamp.proto\x1a\x1econsensus_submit_message.proto\"\xd5\x01\n" +
...
var (
	...
	file_consensus_service_proto_rawDescData []byte
)

func file_consensus_service_proto_rawDescGZIP() []byte {
	file_consensus_service_proto_rawDescOnce.Do(func() {
		file_consensus_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_consensus_service_proto_rawDesc), len(file_consensus_service_proto_rawDesc)))
	})
